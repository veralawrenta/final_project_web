"use client";
import { SalesChart } from "@/components/dashboard-tenant/overview/SalesChart";
import TenantActivity from "@/components/dashboard-tenant/overview/TenantActivity";
...
export default function DashboardOverview() {
  ...
  const dashboardData = {
    profile: {
      name: "Monica Sutrisno",
      avatar: null,
    },
    stats: {
      totalProperties: 5,
      totalActiveTransactions: 3,
