  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-8">
      <div className="space-y-1">
        ...
        {/* <p className="text-sm text-muted-foreground">Step 1 of 2 • Basic details</p> */}
      </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Sunset Beach Villa" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <div className="rounded-md overflow-hidden border">
                <InteractiveMap
                  ...
                  onLocationChange={(lat, lng) => {
                    form.setValue("latitude", parseFloat(lat.toFixed(6)), { shouldValidate: false });
                    form.setValue("longitude", parseFloat(lng.toFixed(6)), { shouldValidate: false });
                  }}
                  height="300px"
                />
              </div>
              <p className="text-xs text-muted-foreground">Click or drag the marker to adjust location</p>
            </CardContent>
          </Card>
                            ...
                            <button
                              ...
                              onClick={() => {
                                const newValue = isSelected
                                  ? field.value.filter((c: string) => c !== amenity.code)
